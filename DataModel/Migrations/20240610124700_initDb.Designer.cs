...
namespace DataModel.Migrations
{
    ...
    [Migration("20240610124700_initDb")]
            ...
            modelBuilder.Entity("DataModel.TableStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreateBy = "admin",
                            CreateDate = new DateTime(2024, 6, 10, 19, 47, 0, 328, DateTimeKind.Local).AddTicks(100),
                        ...
                        new
                        {
                            Id = 2,
                            CreateBy = "admin",
                            CreateDate = new DateTime(2024, 6, 10, 19, 47, 0, 328, DateTimeKind.Local).AddTicks(116),
                        ...
                        new
                        {
                            Id = 3,
                            CreateBy = "admin",
                            CreateDate = new DateTime(2024, 6, 10, 19, 47, 0, 328, DateTimeKind.Local).AddTicks(117),
                        ...
                        new
                        {
                            Id = 4,
                            CreateBy = "admin",
                            CreateDate = new DateTime(2024, 6, 10, 19, 47, 0, 328, DateTimeKind.Local).AddTicks(119),
                        ...
                        new
                        {
                            Id = 5,
                            CreateBy = "admin",
                            CreateDate = new DateTime(2024, 6, 10, 19, 47, 0, 328, DateTimeKind.Local).AddTicks(121),
                        ...
                        new
                        {
                            Id = 6,
                            CreateBy = "admin",
                            CreateDate = new DateTime(2024, 6, 10, 19, 47, 0, 328, DateTimeKind.Local).AddTicks(122),
                        ...
                        new
                        {
                            Id = 7,
                            CreateBy = "admin",
                            CreateDate = new DateTime(2024, 6, 10, 19, 47, 0, 328, DateTimeKind.Local).AddTicks(124),
                        ...
                        new
                        {
                            Id = 8,
                            CreateBy = "admin",
                            CreateDate = new DateTime(2024, 6, 10, 19, 47, 0, 328, DateTimeKind.Local).AddTicks(125),
                            Deskripsi = "Kawin tanggungan 2",
                            IsDeleted = false,
                            JenisStatus = "K2",
